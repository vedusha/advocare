...
public partial class Brochures : System.Web.UI.Page
{
    ...
    protected void SendMail()
    {
        ...
        var toAddress = "ayeshamalshani@gmail.com";
        //Password of your gmail address
        const string fromPassword = "advocare12345";
        // Passing the values and make a email formate to display
        string subject = "Advocare Brochures";
        string body = "Name: " + txtname.Text + "\n";
        body += "Organisation: " + txtorg.Text + "\n";
        ...
        body += "Quantity: " + drpqty.SelectedItem.Text + "\n";
        // smtp settings
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        SendMail();
        Response.Redirect("AfterResources.aspx");

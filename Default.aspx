...
<meta name="keywords" content="advocare, elder-abuse, australia, perth, WA, older-people, help, free, advocacy, aged-care-service" />
<meta name="description" content="Advocare Incorporated (Advocare) is an independent, community based, not for profit organisation that supports and protects the rights of older people and people with disabilities." />
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-56c8143b33f9fe43"></script>
 ...
 <div class ="container-wrapper"> 
     <script>
         (function () {
             var cx = '001927710120675537200:frz4suvq9xw';
...
<div id="banner-wrapper">
    <div id="rotating-item-wrapper">
        <img src="images/05_BigSizeV3.png" alt="Advocare" width="100%"/>
        <img src="images/07_BigSizeV3.png" class="rotating-item" alt="Advocare" width="100%"/>
        <img src="images/08_BigSizeV3.png" alt="" class="rotating-item" width="100%"  />
        <img src="images/05_BigSizeV3.png" alt="Advocare"  class="rotating-item" width="100%"/>
    </div>
</div>
	...
	<div class="content-bg">
		<div id="content">
			...
			<div class="post">
				...
				<h2 class="title">
                    <asp:Label ID="lblheaderhome" runat="server" CssClass="homeheader" Text="Advocare Incorporated"></asp:Label>
                </h2>
				<p class="posted" >Helping people in Western Australia with their aged care services and prevention of elder abuse </p>
                <div class="entry">
                    <div id ="fontSize">
					    <p><strong><b>Advocare Incorporated (Advocare)</b> is an independent, community based, not for profit organisation that supports and protects the rights of older people and people with disabilities.</strong></p>
                        <p style = "width:70%;">We provide advocacy, information and education to: People who receive aged care services and have a concern about the quality of service. People who receive aged care services but are finding it difficult to remain independently at home and would like information on what other services may be available them. Older people (50 years+ for Aboriginal and 60 years+ for non-Aboriginal) who are victims or potential victims of abuse from family or friends
                        </p> 
                    </div>
				</div>
		...
		<div class="sidebar">
            <div>
                ...
                <%--<div class ="sideNav">--%>
                <a class="pansearch font-button plus">
                <input id="fontPlus" type="button" value="Increase size of words"/></a>
                <br /><br />
                <a class="pansearch font-button minus">
                <input id="fontMinus" type="button" value="Decrease size of words"/></a>
                </div><br />
               
                <%--<img alt="" src="images/Copy of Donate.png" style="height: 117px; width: 196px" />--%>
               
                
                <h3 class="title">Latest news</h3>
                <p class="sideNav">
                    <strong><a class="button" href ="latestNews1.aspx" style="color:#C92D92;">Free Elder Abuse Helpline Posters</a> -&nbsp;&nbsp; 19 February 2016 </strong><br />
                            A range of different WA Elder Abuse Helpline posters have been designed to assist older people, their families, carers and organisations working...
			    </p>
			    <div>
				<h3 class="title">Recent Post: Facebook</h3>
                    <div class="fb-page" data-href="https://www.facebook.com/advocareinc" data-tabs="timeline" data-width="80%" data-height="362" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/advocare"><a href="https://www.facebook.com/advocare">AdvoCare</a></blockquote></div></div>
				<ul>
					<li class="first"></li>
				</ul>
			</div>
